export const settingsTranslations = {
  vi: {
    ...
    aboutMeImages: "Hình ảnh cá nhân (About me)",
    addImage: "Thêm ảnh",
    uploading: "Đang tải...",
    noImages: "Chưa có hình ảnh nào.",
    confirmDeleteImage: "Bạn có chắc chắn muốn xóa hình ảnh này?",
    deleteImage: "Xóa ảnh",
  ...
  en: {
    ...
    aboutMeImages: "Profile Images (About me)",
    addImage: "Add Image",
    uploading: "Uploading...",
    noImages: "No images configured yet.",
